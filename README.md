...
```
    ...
    ## [1] lubridate_1.7.9 dplyr_1.0.1     ggplot2_3.3.2   magrittr_1.5   
    ## 
    ## loaded via a namespace (and not attached):
    ##  [1] Rcpp_1.0.5       compiler_4.0.0   pillar_1.4.6     git2r_0.27.1    
    ...
    ## [21] yaml_2.2.1       xfun_0.13        httr_1.4.2       withr_2.2.0     
    ## [25] stringr_1.4.0    knitr_1.28       cranlogs_2.1.1   generics_0.0.2  
    ## [29] vctrs_0.3.2      askpass_1.1      grid_4.0.0       tidyselect_1.1.0
    ## [33] glue_1.4.1       R6_2.4.1         fansi_0.4.1      rmarkdown_2.3   
    ## [37] farver_2.0.3     purrr_0.3.4      splines_4.0.0    tic_0.9.0.9002  
